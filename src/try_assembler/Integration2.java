 ...
 * @author Thainan
 */
public class Integration2 extends Process {
    ...
    public Integration2() {
            ...
            public void initialise() {
                ...
                Task communicator = new OutInDummyCommunicator("OutIn") {
                    ...
                    public void doWork(Exchange exchange) throws TaskExecutionException {
                        ...
                        if (x6.getElementsByTagName("bank").item(0).getTextContent().equals("bankX")) {
            ...
            public void initialise() {
                ...
                Task communicator = new OutInDummyCommunicator("OutIn") {
                    ...
                    public void doWork(Exchange exchange) throws TaskExecutionException {
                        ...
                        if (x7.getElementsByTagName("bank").item(0).getTextContent().equals("bankY")) {
            ...
            public void initialise() {
                ...
                Task communicator = new OutInDummyCommunicator("OutIn") {
                    ...
                    public void doWork(Exchange exchange) throws TaskExecutionException {
                        ...
                        if (x8.getElementsByTagName("bank").item(0).getTextContent().equals("bankZ")) {
        ...
        task[10] = new ContextBasedContentEnricher("CONTEXT BASED ENRICHER T11") {
            ...
            public void doWork(Exchange exchng) throws TaskExecutionException {
                ...
                if (banksArray.get(0).equals("denied")) {
                ...
                if (banksArray.get(1).equals("denied")) {
                    Element bank = x5.createElement("bank");
                    bank.setTextContent("deniedY");
                    banks.appendChild(bank);
                } else {
                ...
                if (banksArray.get(2).equals("denied")) {
                    Element bank = x5.createElement("bank");
                    bank.setTextContent("deniedZ");
                    banks.appendChild(bank);
                } else {
        ...
        task[13] = new Dispatcher("DISPATCHER T14", 1, 3) {
            ...
            public void doWork(Exchange exchange) {
                ...
                if (msgHere.getElementsByTagName("bank").item(0).getTextContent().equals("deniedX")) {
                ...
                if (msgHere.getElementsByTagName("bank").item(0).getTextContent().equals("deniedY")) {
                ...
                if (msgHere.getElementsByTagName("bank").item(0).getTextContent().equals("deniedZ")) {
        ...
        task[18] = new ContextBasedContentEnricher("CONTEXT BASED ENRICHER T19") {
            ...
            public void doWork(Exchange exchng) throws TaskExecutionException {
                ...
                bank.setTextContent(x9.getElementsByTagName("bank").item(0).getTextContent());
                root.appendChild(bank);
        ...
        task[23] = new ContextBasedContentEnricher("CONTEXT BASED ENRICHER T24") {
            ...
            public void doWork(Exchange exchng) throws TaskExecutionException {
                ...
                bank.setTextContent(x10.getElementsByTagName("bank").item(0).getTextContent());
                root.appendChild(bank);
        ...
        task[28] = new ContextBasedContentEnricher("CONTEXT BASED ENRICHER T29") {
            ...
            public void doWork(Exchange exchng) throws TaskExecutionException {
                ...
                Element fiador = x14.createElement("fiador");
                fiador.setTextContent(x8.getElementsByTagName("fiador").item(0).getTextContent());
                root.appendChild(fiador);

                Element garantia = x14.createElement("garantia");
                garantia.setTextContent(x8.getElementsByTagName("garantia").item(0).getTextContent());
                root.appendChild(garantia);

                Element bank = x14.createElement("bank");
                bank.setTextContent(x11.getElementsByTagName("bank").item(0).getTextContent());
                root.appendChild(bank);
        ...
        // ASSEMBLER
        task[29] = new Assembler("ASSEMBLER T30", 3, 1) {
            @Override
            public void doWork(Exchange exchange) throws TaskExecutionException {

                Message<Document> inMsg1 = (Message<Document>) exchange.input[0].poll();
                Message<Document> inMsg2 = (Message<Document>) exchange.input[1].poll();
                Message<Document> inMsg3 = (Message<Document>) exchange.input[2].poll();

                Document x12 = inMsg1.getBody();
                Document x13 = inMsg2.getBody();
                Document x14 = inMsg3.getBody();
                
                Document x15 = XMLHandler.newDocument();
        
                Element root = x15.createElement("XMLASSEMBLER");
                x15.appendChild(root);
                
                Element score = x15.createElement("score");
                score.setTextContent(x12.getElementsByTagName("score").item(0).getTextContent());
                root.appendChild(score);

                Element historic = x15.createElement("historic");
                historic.setTextContent(x12.getElementsByTagName("historic").item(0).getTextContent());
                root.appendChild(historic);

                Element name = x15.createElement("name");
                name.setTextContent(x12.getElementsByTagName("name").item(0).getTextContent());
                root.appendChild(name);

                Element adress = x15.createElement("adress");
                adress.setTextContent(x12.getElementsByTagName("adress").item(0).getTextContent());
                root.appendChild(adress);

                Element cpf = x15.createElement("cpf");
                cpf.setTextContent(x12.getElementsByTagName("cpf").item(0).getTextContent());
                root.appendChild(cpf);

                Element birth = x15.createElement("birth");
                birth.setTextContent(x12.getElementsByTagName("birth").item(0).getTextContent());
                root.appendChild(birth);

                Element income = x15.createElement("income");
                income.setTextContent(x12.getElementsByTagName("income").item(0).getTextContent());
                root.appendChild(income);

                Element value = x15.createElement("value");
                value.setTextContent(x12.getElementsByTagName("value").item(0).getTextContent());
                root.appendChild(value);

                Element instalment = x15.createElement("instalment");
                instalment.setTextContent(x12.getElementsByTagName("instalment").item(0).getTextContent());
                root.appendChild(instalment);

                Element fiador = x15.createElement("fiador");
                fiador.setTextContent(x12.getElementsByTagName("fiador").item(0).getTextContent());
                root.appendChild(fiador);

                Element garantia = x15.createElement("garantia");
                garantia.setTextContent(x12.getElementsByTagName("garantia").item(0).getTextContent());
                root.appendChild(garantia);
                
                Element banksAndInterests = x15.createElement("banksAndInterests");
                root.appendChild(banksAndInterests);
                
                if (x12.getElementsByTagName("bank").item(0).getTextContent().equals("bankX")) {
                    
                    Element bankAndInterest = x15.createElement("bankAndInterest");
                    bankAndInterest.setTextContent("bankX: " + x12.getElementsByTagName("interestRate").item(0).getTextContent());
                    banksAndInterests.appendChild(bankAndInterest);
                    
                }
                
                if (x13.getElementsByTagName("bank").item(0).getTextContent().equals("bankY")) {
                    
                    Element bankAndInterest = x15.createElement("bankAndInterest");
                    bankAndInterest.setTextContent("bankY: " + x13.getElementsByTagName("interestRate").item(0).getTextContent());
                    banksAndInterests.appendChild(bankAndInterest);
                    
                }
                
                if (x14.getElementsByTagName("bank").item(0).getTextContent().equals("bankZ")) {
                    
                    Element bankAndInterest = x15.createElement("bankAndInterest");
                    bankAndInterest.setTextContent("bankZ: " + x14.getElementsByTagName("interestRate").item(0).getTextContent());
                    banksAndInterests.appendChild(bankAndInterest);
                ...
                // DEBUG
                XMLHandler.writeXmlFile(outMsg.getBody(), "debugs/T30_X15.xml");
                // DEBUG
        ...
        // SLIMMER T31
        task[30] = new Slimmer("SLIMMER T31") {
            @Override
            public void doWork(Exchange exchng) throws TaskExecutionException {
                Message<Document> inMsg = (Message<Document>) exchng.input[0].poll();
                ...
                // DEBUG
                XMLHandler.writeXmlFile(outMsg.getBody(), "debugs/T31_X16.xml");
                // DEBUG
        ...
        task[30].output[0].bind(exitPort.getInterSlot());
        addTask(task[30]);
    }
